...
export const ISLAND_CONFIGS: Record<IslandId, IslandConfig> = {
  current: {
    ...
    outlineOpacity: "0.82",
    focusScale: 1.34,
    focusTranslateX: "-122rpx",
    focusTranslateY: "-612rpx",
    focusSceneHeight: "1200rpx",
    tagSlots: [
      { left: "342rpx", top: "746rpx", width: "186rpx", highlighted: true },
      { left: "442rpx", top: "868rpx", width: "172rpx" },
      { left: "272rpx", top: "948rpx", width: "208rpx" },
      { left: "188rpx", top: "1052rpx", width: "194rpx" },
      { left: "390rpx", top: "1098rpx", width: "192rpx" },
    ],
  ...
  mist: {
    ...
    focusSceneHeight: "1200rpx",
    tagSlots: [
      { left: "366rpx", top: "516rpx", width: "200rpx" },
      { left: "196rpx", top: "664rpx", width: "210rpx", highlighted: true },
      { left: "308rpx", top: "812rpx", width: "184rpx" },
      { left: "204rpx", top: "932rpx", width: "172rpx" },
    ],
  ...
  ember: {
    ...
    outlineOpacity: "0.9",
    focusScale: 1.74,
    focusTranslateX: "-278rpx",
    focusTranslateY: "-520rpx",
    focusSceneHeight: "1160rpx",
    tagSlots: [
      { left: "374rpx", top: "602rpx", width: "186rpx" },
      { left: "232rpx", top: "708rpx", width: "184rpx", highlighted: true },
      { left: "168rpx", top: "800rpx", width: "198rpx" },
    ],
  ...
  lagoon: {
    ...
    focusTranslateY: "-768rpx",
    focusSceneHeight: "1230rpx",
    tagSlots: [
      { left: "174rpx", top: "530rpx", width: "164rpx" },
      { left: "314rpx", top: "676rpx", width: "178rpx", highlighted: true },
      { left: "214rpx", top: "820rpx", width: "194rpx" },
      { left: "292rpx", top: "948rpx", width: "174rpx" },
    ],
  ...
  azure: {
    ...
    outlineOpacity: "0.92",
    focusScale: 1.98,
    focusTranslateX: "-462rpx",
    focusTranslateY: "-930rpx",
    focusSceneHeight: "1160rpx",
    tagSlots: [
      { left: "390rpx", top: "616rpx", width: "176rpx", highlighted: true },
      { left: "338rpx", top: "742rpx", width: "182rpx" },
      { left: "384rpx", top: "862rpx", width: "162rpx" },
    ],
  ...
  sprout: {
    ...
    outlineOpacity: "0.96",
    focusScale: 2.38,
    focusTranslateX: "-674rpx",
    focusTranslateY: "-756rpx",
    focusSceneHeight: "1140rpx",
    tagSlots: [
      { left: "404rpx", top: "612rpx", width: "154rpx", highlighted: true },
      { left: "358rpx", top: "726rpx", width: "178rpx" },
      { left: "394rpx", top: "836rpx", width: "170rpx" },
    ],
  ...
  pebble: {
    ...
    tagSlots: [
      { left: "176rpx", top: "632rpx", width: "174rpx", highlighted: true },
      { left: "228rpx", top: "752rpx", width: "184rpx" },
    ],
